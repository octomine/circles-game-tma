...
export const spawnCircle = (
  ...
  const x = Math.random() * (app.screen.width - GAME_CONFIG.CIRCLE_RADIUS * 2) + GAME_CONFIG.CIRCLE_RADIUS;
  const y = Math.random() * (app.screen.height - GAME_CONFIG.CIRCLE_RADIUS * 2) + GAME_CONFIG.CIRCLE_RADIUS;
